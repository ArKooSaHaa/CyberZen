      ...
      <div className="search-filter-section">
        ...
        <div className="filter-controls">
          ...
          >
            ...
            <option key="received-status" value="received">Received</option>
            <option key="processing-status" value="processing">Processing</option>
          ...
          >
            ...
            <option key="phishing-type" value="Phishing">Phishing</option>
            <option key="malware-type" value="Malware">Malware</option>
            <option key="data-breach-type" value="Data Breach">Data Breach</option>
            <option key="ransomware-type" value="Ransomware">Ransomware</option>
            <option key="social-engineering-type" value="Social Engineering">Social Engineering</option>
          </select>
        </div>
      </div>
              ...
              {currentReports.map((report) => (
                <tr key={report.trackNumber} className="report-row" onClick={() => handleReportClick(report)}>
                  ...
                  <td className="actions">
                    ...
                    >
                      <option key={`${report.trackNumber}-received`} value="received">Received</option>
                      <option key={`${report.trackNumber}-processing`} value="processing">Processing</option>
                      <option key={`${report.trackNumber}-completed`} value="completed">Completed</option>
                    </select>
                  </td>
                </tr>
              ))}
